...
class Individu{
    ...
    public Viable() { 
        var hax_1 : string = this.genome.substring(1, 2)
        var hax_2 : string = this.genome.substring(2, 3)
        var hax_3 : string = this.genome.substring(3, 4)
...
class IndividuFactory{
    ...
    public getIndividu(){
        var genome : string = hex[Math.floor(Math.random() * 2)] + hex[Math.floor(Math.random() * 15)] + hex[Math.floor(Math.random() * 15)] + hex[Math.floor(Math.random() * 15)] 
        return new Individu(genome)
    }

    public getPopulation(n : number){
...
class Population{
    ...
    public population : Individu[] = [];

    public add(individu : Individu){
...
class Monstre{
    public Population : Individu[] = []
    public select(individu: Individu){
